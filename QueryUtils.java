...
public final class QueryUtils {
    ...
    public static ArrayList<EarthquakeParam> extractEarthquakes() {

        // Create an empty ArrayList that we can start adding earthquakes to
        ArrayList<EarthquakeParam> earthquakes = new ArrayList<>();
        ...
        try {
            ...
            JSONObject baseJsonArray = new JSONObject(SAMPLE_JSON_RESPONSE);
            JSONArray earthquakeArray = baseJsonArray.getJSONArray("features");

            for (int i=0; i  < earthquakeArray.length() ;i++) {
                JSONObject currentEarthquake = earthquakeArray.getJSONObject(i);
                JSONObject properties = currentEarthquake.getJSONObject("feature");
                String magnitude = properties.getString("mag");
                String location = properties.getString("place");
                String time = properties.getString("time");
                EarthquakeParam earthquake = new EarthquakeParam(magnitude,location,time);
